...
interface User {
 ...
 name: string;
 email: string;
 type: "business" | "investor" | "admin";
 business_profile?: any;
 investor_profile?: any;
 admin_role?: "superuser" | "compliance_officer" | "support_staff";
}
...
interface AuthContextType {
 ...
 loading: boolean;
 login: (email: string, password: string, type: "business" | "investor" | "admin") => Promise<void>;
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
 ...
 const login = async (email: string, password: string, type: "business" | "investor" | "admin") => {
   try {
